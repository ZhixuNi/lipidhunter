...
class NameParserFA:
    ...
    def __init__(self, lclass = 'PC'):
        ...
        self.lipid_output_format = {'PC': {'[M+HCOO]-':{'OBS_FA': ['[FA-H]-'],
                                                        'OBS_LYSO': ['[LPL-H]-', '[LPL-H2O-H]-']},
                                           '[M+CH3COO]-':{'OBS_FA': ['[FA-H]-'],
                                                        'OBS_LYSO': ['[LPL-H]-', '[LPL-H2O-H]-']}},
                                    'PE': {'[M-H]-':{'OBS_FA': ['[FA-H]-'],
                                                     'OBS_LYSO': ['[LPL-H]-', '[LPL-H2O-H]-']}},
                                    'PS': {'[M-H]-':{'OBS_FA': ['[FA-H]-'],
                                    ...
                                    'PA': {'[M-H]-': {'OBS_FA': ['[FA-H]-'],
                                                      'OBS_LYSO': ['[LPL-H]-', '[LPL-H2O-H]-']}},
                                    'DG': {'[M+NH4]+': {'OBS_FA': ['[FA-H2O+H]+'],
                                                      'OBS_LYSO': ['[MG-H2O+H]+']}},
                                    'TG': {'[M+NH4]+': {'OBS_FA': ['[FA-H2O+H]+', '[MG-H2O+H]+'],
                                                        'OBS_LYSO': ['[M-FA+H]+']},
                                           '[M+Na]+': {'OBS_FA': ['[FA-H2O+H]+', '[MG-H2O+H]+'],
                                                       'OBS_LYSO': ['[M-FA+Na]+', '[M-(FA-H+Na)+H]+']}},
                                    'Cer': {'[M+H]+': {'OBS_FA': ['[LCB...+H]+', '[FA-OH+NH3]+'],
                                                       'OBS_LYSO': ['[M...+H]+']}},
                                    'LPC': {'[M+HCOO]-':{'OBS_FA': ['[FA-H]-'],
                                                        'OBS_LYSO': []},
                                           '[M+CH3COO]-':{'OBS_FA': ['[FA-H]-'],
                                                        'OBS_LYSO': []}},
                                    'LPE': {'[M-H]-':{'OBS_FA': ['[FA-H]-'],
